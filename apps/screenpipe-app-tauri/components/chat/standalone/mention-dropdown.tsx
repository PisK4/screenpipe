          ...
          return (
            <div key={category}>
              <div className="px-2 py-1 text-[10px] font-medium uppercase tracking-wider text-muted-foreground bg-muted/30 border-b border-border/50">
                {category === "command"
                  ? t("chat.mention.categoryCommand")
                  : category === "chat"
                  ? t("chat.mention.categoryRecentChats")
                  : category === "skill"
                    ? t("chat.mention.categorySkills")
                    : category === "range"
                      ? t("chat.mention.categoryTimeRanges")
                  : category === "time"
                  ? t("chat.mention.categoryTime")
                  : category === "content"
                    ? t("chat.mention.categoryContentType")
                    : category === "speaker"
                      ? t("chat.mention.categorySpeakers")
                      : category === "tag"
                        ? t("chat.mention.categoryTags")
                        : t("chat.mention.categoryApps")}
              </div>
