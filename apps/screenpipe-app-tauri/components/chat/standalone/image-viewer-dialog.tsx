          ...
          <>
            <div className="flex items-center justify-between px-4 py-3 border-b border-border/50 shrink-0">
              <span className="text-sm font-medium text-muted-foreground">
                {t("chat.imageViewer.counter", { index: imageViewer.index + 1, total: imageViewer.images.length })}
              </span>
              <button
                type="button"
            ...
            <div className="flex-1 flex items-center justify-center min-h-0 p-4 bg-background/50">
              ...
              <img
                ...
                alt={t("chat.imageViewer.attachedImageN", { index: imageViewer.index + 1 })}
            ...
            <div className="flex items-center justify-center gap-4 py-3 border-t border-border/50 shrink-0">
              <button
                ...
                aria-label={t("chat.imageViewer.previous")}
              >
