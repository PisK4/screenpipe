...
export function ComposerInputBox({
  ...
  return (
    <div
      className={cn(
        "flex flex-col rounded-lg border bg-input ring-offset-background transition-colors duration-150 focus-within:border-input-focus focus-within:ring-ring/30 focus-within:ring-2",
    ...
    >
      <div className="relative flex-1 min-w-0">
        ...
        <textarea
          ...
          rows={1}
          className={cn(
            "w-full min-h-[38px] border-0 bg-transparent px-3 text-sm placeholder:text-muted-foreground focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 caret-accent-highlight resize-none overflow-y-auto scrollbar-minimal py-2",
